...
class UserPreferencesRepositoryImpl(
    ...
    companion object {
        ...
        private val KEY_NAME = stringPreferencesKey("user_name") // Key baru
        private val KEY_AVATAR = stringPreferencesKey("user_avatar")
        private val KEY_IS_LOGGED_IN = booleanPreferencesKey("is_logged_in")
    }

    override suspend fun saveLogin(email: String, password: String, token: String, idUser: String, name: String, avatar: String?) {
        context.dataStore.edit { prefs ->
            prefs[KEY_EMAIL] = email
            prefs[KEY_PASSWORD] = password
            prefs[KEY_TOKEN] = token
            prefs[KEY_ID_USER] = idUser
            prefs[KEY_NAME] = name // Simpan nama
            prefs[KEY_AVATAR] = avatar.orEmpty() // Simpan avatar
    ...
    override val userName: Flow<String?> = context.dataStore.data.map { it[KEY_NAME] } // Aliran data nama
    override val userAvatar: Flow<String?> = context.dataStore.data.map { it[KEY_AVATAR] }
