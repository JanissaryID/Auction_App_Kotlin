...
class PocketBaseRepository(
    ...
    suspend fun loginWithEmailPassword(email: String, password: String): AuthResult {
        println("DEBUG: Attempting login for $email at $baseHost")
        ...
        println("DEBUG: Login successful, token: ${loginResult.token.take(10)}...")
        ...
        println("DEBUG: Profile fetched: ${userProfile.name}")
        return AuthResult(
